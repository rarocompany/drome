...
class Paypal_Express_Review_Request
{
    ...
    public function __construct()
    {
        ...
        if ($this->check_condition()) /* checks the banner is active now */ {
            $this->banner_message = sprintf(__("Hey, we at %sWebToffee%s would like to thank you for using our plugin. We would really appreciate if you could take a moment to drop a quick review that will inspire us to keep going.", 'express-checkout-paypal-payment-gateway-for-woocommerce'), '<b>', '</b>');
