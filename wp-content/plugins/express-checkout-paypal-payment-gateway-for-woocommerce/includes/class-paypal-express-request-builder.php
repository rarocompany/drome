...
class Eh_PE_Request_Built
{
    ...
    public function add_payment_params($items)
    {
        ...
        foreach ($items as $item_key => $item_value) {
            if ($flag_empty_shipping_details && ($item_key == 'SHIPTONAME' || $item_key == 'SHIPTOSTREET' || $item_key == 'SHIPTOCITY' || $item_key == 'SHIPTOZIP' || $item_key == 'SHIPTOCOUNTRYCODE' || $item_key == 'SHIPTOPHONENUM' || $item_key == 'SHIPTOSTATE')) {
                    continue;
            }
